			       ...
			       unsigned int quot, unsigned int quot_frac)
{
...
#ifdef CONFIG_ARCH_LEIPZIG
	/* Disable Baud block */
	serial_port_out(port, UART_SCR, 0x0);
	/* Re-calculate quot */
	...
	quot = DIV_ROUND_CLOSEST(((port->uartclk - (16 * quot * baud)) * 64),
		(16 * baud));
	/* Configure fractional value & Enable Baud block */
	serial_port_out(port, UART_SCR, 0x40 | quot);
#endif
}
