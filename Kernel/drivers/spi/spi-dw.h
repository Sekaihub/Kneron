...
#define DW_PSSI_CTRLR0_SPIFRF_MASK		GENMASK(22, 21)
...
struct dw_spi_dma_ops {
	...
	bool (*can_dma_mem)(struct spi_controller *master,
			    struct spi_device *spi,
			    const struct spi_mem_op *op);
	int (*dma_mem_setup)(struct dw_spi *dws,
			     const struct spi_mem_op *op);
	int (*dma_mem_exec)(struct dw_spi *dws,
			    struct spi_device *spi,
			    const struct spi_mem_op *op);
