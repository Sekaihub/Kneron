...
static ssize_t ffs_item_opts_use_sg_show(struct config_item *item,
						char *page)
{
	struct f_fs_opts *opts = to_ffs_opts(item);
	int result;
...
static ssize_t ffs_item_opts_use_sg_store(struct config_item *item,
...
CONFIGFS_ATTR(ffs_item_opts_, use_sg);

static struct configfs_attribute *ffs_item_attrs[] = {
	&ffs_item_opts_attr_use_sg,
	NULL,
};

static const struct config_item_type ffs_func_type = {
	.ct_item_ops	= &ffs_item_ops,
	.ct_attrs	= ffs_item_attrs,
