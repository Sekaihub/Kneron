 ...
 * File: cfg_sbif.h
 *
 * Description : Secure boot constants (special template to force RSA 3072-bit)
 */
 ...
 * Notice this is set to 3072 to force support for RSA3072
 */
#define SBIF_CFG_RSA_BITS             3072
