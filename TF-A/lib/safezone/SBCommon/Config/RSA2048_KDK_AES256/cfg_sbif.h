 ...
 * File: cfg_sbif.h
 *
 * Description : Secure boot constants (special template to force RSA 2048-bit)
 */
 ...
 * Notice this is set to 2048 to force support for RSA2048
 */
#define SBIF_CFG_RSA_BITS             2048
