 ...
 *               This interface can be implemented by both SW and HW AES
 *               implementations. Interface is minimalistic to allow small
 *               footprint. This interface is used by SBIF_TOOLS to get access
 *               to cryptographic hardware or software implementation.
 */
...
#ifndef INCLUDE_GUARD_AES_IF_H
#define INCLUDE_GUARD_AES_IF_H
