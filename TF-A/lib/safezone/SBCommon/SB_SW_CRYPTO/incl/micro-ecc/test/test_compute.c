...
int main() {
    ...
    for (c = 0; c < num_curves; ++c) {
        for (i = 0; i < 256; ++i) {
            ...
            c_memset(public, 0, sizeof(public));
            c_memset(public_computed, 0, sizeof(public_computed));
            ...
            if (c_memcmp(public, public_computed, sizeof(public)) != 0) {
        ...
        c_memset(private, 0, sizeof(private));
