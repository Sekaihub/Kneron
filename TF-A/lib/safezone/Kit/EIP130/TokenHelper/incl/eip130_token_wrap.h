...
#ifdef EIP130_ENABLE_ENCRYPTED_VECTOR
/*----------------------------------------------------------------------------
...
{
    CommandToken_p->W[0] = (EIP130TOKEN_OPCODE_SYMWRAP |
                            EIP130TOKEN_SUBCODE_ENCRYPTVECTOR);
    CommandToken_p->W[2] = (Eip130TokenWord_t)AssetId;
    CommandToken_p->W[3] = (((Eip130TokenWord_t)AssetNumber & MASK_6_BITS) << 16) |
                           ((Eip130TokenWord_t)OutputDataLengthInBytes & MASK_11_BITS);
    CommandToken_p->W[4] = (Eip130TokenWord_t)(OutputDataAddress);
    CommandToken_p->W[5] = (Eip130TokenWord_t)(OutputDataAddress >> 32);
}
