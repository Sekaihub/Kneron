...
{
    Eip130FunctionStatus_t rv = (Eip130FunctionStatus_t)ResultToken_p->W[0] >> 24;
    if (rv != 0)
    {
        if ((rv & (Eip130FunctionStatus_t)BIT_7) != (Eip130FunctionStatus_t)0)
        {
            rv = -rv;
        }
        else if ((rv & (Eip130FunctionStatus_t)(BIT_6 | BIT_5)) != (Eip130FunctionStatus_t)BIT_6)
        {
            rv = -rv;
        }
        else
        {
            rv = (rv & (Eip130FunctionStatus_t)MASK_5_BITS);
        }
    }
