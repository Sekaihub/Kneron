...
typedef enum
{
    EIP130TOKEN_CRYPTO_ALGO_AES      = 0U,
    EIP130TOKEN_CRYPTO_ALGO_DES      = 1U,
    EIP130TOKEN_CRYPTO_ALGO_3DES     = 2U,
    EIP130TOKEN_CRYPTO_ALGO_CHACHA20 = 7U,
    EIP130TOKEN_CRYPTO_ALGO_SM4      = 8U,
    EIP130TOKEN_CRYPTO_ALGO_ARIA     = 9U
} Eip130Token_Encryption_Algoritms_t;

typedef enum
{
    EIP130TOKEN_CRYPTO_MODE_ECB     = 0U,
    EIP130TOKEN_CRYPTO_MODE_CBC     = 1U,
    EIP130TOKEN_CRYPTO_MODE_CTR     = 2U,
    EIP130TOKEN_CRYPTO_MODE_ICM     = 3U,
    EIP130TOKEN_CRYPTO_MODE_f8      = 4U,
    EIP130TOKEN_CRYPTO_MODE_CCM     = 5U,
    EIP130TOKEN_CRYPTO_MODE_XTS     = 6U,
    EIP130TOKEN_CRYPTO_MODE_GCM     = 7U,
    EIP130TOKEN_CRYPTO_MODE_ENCRYPT = 0U,
    EIP130TOKEN_CRYPTO_MODE_AEAD    = 1U
} Eip130Token_Encryption_Modes_t;
...
{
    CommandToken_p->W[11] |= ((Eip130TokenWord_t)GCMMode << 13);
}
#endif


#if defined(EIP130_HW_V3) && \
    (defined(EIP130_ENABLE_SYM_ALGO_AES_GCM) || \
     defined(EIP130_ENABLE_SYM_ALGO_ARIA_GCM) || \
...
{
    Eip130Token_Command_WriteByteArray(CommandToken_p, 26U,
