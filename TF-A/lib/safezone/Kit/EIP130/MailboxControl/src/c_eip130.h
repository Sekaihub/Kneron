...
//#define EIP130_ENABLE_HASHMAC_LAYOUT_V2       /* Enable the use of Hash/MAC token layout V2 */
//#define EIP130_ENABLE_TRNG_CUTOFF             /* Enable the use of TRNG cutoff values */
...
#ifndef EIP130_HW_V3
#error "EIP130_FW_ASSETPOLICY_V2 requires HWv3"
#endif
#endif

#if defined EIP130_ENABLE_FIRMWARE_HIBERNATION || \
    defined EIP130_ENABLE_EXTSERVICE
#ifndef EIP130_ENABLE_EMMC
#error "EIP130_ENABLE_EMMC is required when using eMMC related functionality"
#endif
#endif
