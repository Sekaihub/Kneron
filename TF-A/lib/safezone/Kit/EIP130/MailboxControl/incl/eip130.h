 ...
 *     and Boot token. Note that the mailbox will be unlinked after this function call
 *
 * Firmware_p
 ...
 * The firmware login must be performed after each hard reset or power-cycle
 * before any other Token can be used. However, the following Tokens can be
 * used without a prior firmware login:
 * - SystemInfo
 * - Reset
 * - Static Asset Search
 * - Public Data Read
