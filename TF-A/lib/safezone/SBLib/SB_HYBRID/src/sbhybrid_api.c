...
/*----------------------------------------------------------------------------
 * SB_Image_Inplace_Verify
 */
static SB_Result_t
SB_Image_Inplace_Verify(SB_StorageArea_t * const Storage_p,
                        void * PollParam_p,
                        ...
                        uint32_t VectorCount)
{
    ...
    const uint32_t AlgoType = Load_BE32(&Header_p->PubKeyType) >> 29;
    const uint32_t CurveType = (Load_BE32(&Header_p->PubKeyType) >> 24) & 0x1f;
    ...
    const uint32_t CertificateCount = Load_BE32(&Header_p->
                                                         CertificateCount);
 ...
 */
SB_Result_t
SB_Image_Verify(SB_StorageArea_t * const Storage_p,
                void * PollParam_p,
                const SBIF_PublicKey_t * PublicKey_p,
                const uint8_t * const Hash_p,
                const SBIF_Header_t * Header_p,
                ...
                uint32_t VectorCount)
{
    ...
    return SB_Image_Inplace_Verify(Storage_p,
                                   PollParam_p,
                                   PublicKey_p,
                                   Hash_p,
                                   Header_p,
