...
#define SBHYBRID_PUBLICKEY_POLICY   (SBHYBRID_ACCESS_POLICY              | \
                                     ...
                                     EIP130_ASSET_POLICY_ACA_ECDSA       | \
                                     EIP130_ASSET_POLICY_ACH_SHA512)
#else
#define SBHYBRID_PUBLICKEY_POLICY   (SBHYBRID_ACCESS_POLICY                | \
                                     EIP130_ASSET_POLICY_PK_ECC_ECDSA_SIGN | \
...
#define SBHYBRID_PUBLICKEY_POLICY   (SBHYBRID_ACCESS_POLICY              | \
                                     EIP130_ASSET_POLICY_ASYM_SIGNVERIFY | \
                                     EIP130_ASSET_POLICY_ACA_ECDSA       | \
                                     EIP130_ASSET_POLICY_ACH_SHA384)
#else
#define SBHYBRID_PUBLICKEY_POLICY   (SBHYBRID_ACCESS_POLICY                | \
                                     EIP130_ASSET_POLICY_PK_ECC_ECDSA_SIGN | \
                                     EIP130_ASSET_POLICY_PUBLIC_KEY        | \
...
#define SBHYBRID_PUBLICKEY_POLICY   (SBHYBRID_ACCESS_POLICY              | \
                                     EIP130_ASSET_POLICY_ASYM_SIGNVERIFY | \
                                     EIP130_ASSET_POLICY_ACA_ECDSA       | \
                                     EIP130_ASSET_POLICY_ACH_SHA224)
#else
#define SBHYBRID_PUBLICKEY_POLICY   (SBHYBRID_ACCESS_POLICY                | \
                                     EIP130_ASSET_POLICY_PK_ECC_ECDSA_SIGN | \
                                     EIP130_ASSET_POLICY_PUBLIC_KEY        | \
                                            ...
                                            SBLIB_CFG_XM_MAILBOXNR, NULL))
            {
                ...
                case 0:
                    ...
                    sbres = SBHYBRID_AssetCreate_SendCommand(Context_p,
                                                             ...
                                                             (SBHYBRID_ACCESS_POLICY |
                                                              EIP130_ASSET_POLICY_PUBLIC_KEY_PARAM),
#endif
                ...
                case 2:
                    ...
                    sbres = SBHYBRID_AssetLoadPlaintext_SendCommand(Context_p,
                                                                    ...
                                                                    Context_p->Params,
                                                                    (uint16_t)Context_p->ParamsInBytes);
                    break;
