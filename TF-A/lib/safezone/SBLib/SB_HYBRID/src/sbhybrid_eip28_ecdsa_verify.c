                          ...
                          const uint32_t WordCount)
{
    ...
    BigUInt.StoreAsMSB = true;
    BigUInt.Bytes_p = (uint8_t *)discard_const(&ZeroByte);
    BigUInt.ByteCount = 1;
 ...
 */
void
SBHYBRID_EIP28_EcdsaVerify_Init(SBHYBRID_EIP28_Context_t * const Verify_p,
 ...
 */
void
SBHYBRID_EIP28_EcdsaVerify_SetDigest(SBHYBRID_EIP28_Context_t * const Verify_p,
 ...
 */
SB_Result_t
SBHYBRID_EIP28_EcdsaVerify_RunFsm(SBHYBRID_EIP28_Context_t * const Verify_p)
{
    EIP28_IOArea_t * const IOArea_p = &Verify_p->EIP28_IOArea;
