...
#define FB_EPNUM		1	// fastboot use EP 1 (for bulk out/in)
#define FB_NUM_IN_EPS		2	// fastboot need 2 in_eps
#define FB_NUM_OUT_EPS		2	// fastboot need 2 out_eps
#define FB_OS_DESC_NUM		1
#undef FASTBOOT_UUU_SUPPORT
