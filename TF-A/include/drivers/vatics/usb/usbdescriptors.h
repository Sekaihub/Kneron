...
// from <u-boot>/include/asm-generic/int-ll64.h
...
{
	INFO("usb device descriptor\n");
	INFO("\tbLength %2.2x\n", d->bLength);
	INFO("\tbDescriptorType %2.2x\n", d->bDescriptorType);
	INFO("\tbcdUSB %4.4x\n", d->bcdUSB);
	INFO("\tbDeviceClass %2.2x\n", d->bDeviceClass);
	INFO("\tbDeviceSubClass %2.2x\n", d->bDeviceSubClass);
	INFO("\tbDeviceProtocol %2.2x\n", d->bDeviceProtocol);
	INFO("\tbMaxPacketSize0 %2.2x\n", d->bMaxPacketSize0);
	INFO("\tidVendor %4.4x\n", d->idVendor);
	INFO("\tidProduct %4.4x\n", d->idProduct);
	INFO("\tbcdDevice %4.4x\n", d->bcdDevice);
	INFO("\tiManufacturer %2.2x\n", d->iManufacturer);
	INFO("\tiProduct %2.2x\n", d->iProduct);
	INFO("\tiSerialNumber %2.2x\n", d->iSerialNumber);
	INFO("\tbNumConfigurations %2.2x\n", d->bNumConfigurations);
}
