...
struct cont_info {
	...
	int (*cont_enable)(void);
	int (*cont_disable)(void);
	int (*cont_pre_xfer)(void);
	int (*cont_post_xfer)(void);
};
...
struct nand_device {
	...
	int (*mtd_read_page)(struct nand_device *nand, unsigned int page,
			     uintptr_t buffer);
	int (*mtd_read)(struct nand_device *nand, unsigned int page,
		unsigned int offset, uintptr_t buffer, unsigned int len);
	const struct cont_info *cont_info;
};
