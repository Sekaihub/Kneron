...
typedef struct _PMU_SMB_LPDDR4_1D_t {
   ...
   uint8_t  BPZNResVal ;      // Byte offset 0x09, CSR Addr 0x54004, Direction=In
                              // Overwrite the value of precision resistor connected to Phy BP_ZN
   ...
   uint8_t  UseBroadcastMR;   // Byte offset 0x18, CSR Addr 0x5400c, Direction=In
                              ...
                              // 
                              //    0x0 = Use MR<1:4, 11:14, 16:17, 22, 24>_A0 for rank 0 channel A
                              //              Use MR<1:4, 11:14, 16:17, 22, 24>_B0 for rank 0 channel B
                              //              Use MR<1:4, 11:14, 16:17, 22, 24>_A1 for rank 1 channel A
                              //              Use MR<1:4, 11:14, 16:17, 22, 24>_B1 for rank 1 channel B
                              // 
                              //    0x1 = Use MR<1:4, 11:14, 16:17, 22, 24>_A0 setting for all channels/ranks
                              // 
                              // It is recommended in most LPDDR4 system configurations to set this to 1.
                              // It is recommended in LPDDR4x system configurations to set this to 0.
   uint8_t  Lp4Quickboot;     // Byte offset 0x19, CSR Addr 0x5400c, Direction=In
                              // Enable Quickboot. It must be set to 0x0 since Quickboot is only supported in dedicated Quickboot firmware.
