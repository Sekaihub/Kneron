...
// // [dwc_ddrphy_phyinit_softSetMb] Setting mb_LPDDR4_1D[0].DRAMFreq to 0xaf0
...
// // [phyinit_print_dat] // 
// // [phyinit_print_dat] // ####################################################
// // [phyinit_print_dat] userInputBasic.Frequency[0] = 1400
...
// // [phyinit_print_dat] mb_LPDDR4_1D[0].DRAMFreq = 0xaf0
...
// // [phyinit_print_dat] mb_LPDDR4_1D[0].PhyVref = 0x12
...
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR12_A0 = 0x14
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR13_A0 = 0x8
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR14_A0 = 0x20
...
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR12_A1 = 0x14
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR13_A1 = 0x8
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR14_A1 = 0x20
...
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR12_B0 = 0x14
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR13_B0 = 0x8
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR14_B0 = 0x20
...
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR12_B1 = 0x14
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR13_B1 = 0x8
// // [phyinit_print_dat] mb_LPDDR4_1D[0].MR14_B1 = 0x20
...
// //##############################################################
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming TxSlewRate::TxPreDrvMode to 0x1\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming TxSlewRate::TxPreP to 0xf\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming TxSlewRate::TxPreN to 0xf\n");
...
// INFO("[phyinit_C_initPhyConfig] Pstate=0,  Memclk=1400MHz, Programming PllCtrl2 to 19 based on DfiClk frequency = 700.\n");
// 
// //##############################################################
// //
...
// //
// //##############################################################
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming ARdPtrInitVal to 0x2\n");
writew(0x2, DDRNSDMC_PUB_MMR_BASE + 2 * 0x2002e);
// 
// //##############################################################
// // Seq0BGPR4       = 0: Make ProcOdtAlwaysOn = 0 and ProcOdtAlwaysOff = 0 
// //##############################################################
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming ProcOdtCtl: Seq0BGPR4.ProcOdtAlwaysOff  to 0x0\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming ProcOdtCtl: Seq0BGPR4.ProcOdtAlwaysOn   to 0x0\n");
writew(0x0, DDRNSDMC_PUB_MMR_BASE + 2 * 0x90204);
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DqsPreambleControl::TwoTckRxDqsPre to 0x1\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DqsPreambleControl::TwoTckTxDqsPre to 0x1\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DqsPreambleControl::PositionDfeInit to 0x0\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DqsPreambleControl::LP4TglTwoTckTxDqsPre to 0x1\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DqsPreambleControl::LP4PostambleExt to 0x1\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DqsPreambleControl::LP4SttcPreBridgeRxEn to 0x1\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DqsPreambleControl to 0x1e3\n");
writew(0x1e3, DDRNSDMC_PUB_MMR_BASE + 2 * 0x20024);
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DbyteDllModeCntrl to 0x2\n");
writew(0x2, DDRNSDMC_PUB_MMR_BASE + 2 * 0x2003a);
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DllLockParam to 0x212\n");
writew(0x212, DDRNSDMC_PUB_MMR_BASE + 2 * 0x2007d);
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DllGainCtl to 0x61\n");
writew(0x61, DDRNSDMC_PUB_MMR_BASE + 2 * 0x2007c);
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming ProcOdtTimeCtl to 0x3\n");
writew(0x3, DDRNSDMC_PUB_MMR_BASE + 2 * 0x20056);
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming TxOdtDrvStren::ODTStrenP to 0x0\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming TxOdtDrvStren::ODTStrenN to 0x18\n");
...
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming TxImpedanceCtrl1::DrvStrenFSDqP to 0x18\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming TxImpedanceCtrl1::DrvStrenFSDqN to 0x18\n");
...
// INFO("[phyinit_C_initPhyConfig] Programming ATxImpedance::ADrvStrenP to 0x7\n");
// INFO("[phyinit_C_initPhyConfig] Programming ATxImpedance::ADrvStrenN to 0x7\n");
writew(0xe7, DDRNSDMC_PUB_MMR_BASE + 2 * 0x43);
writew(0xe7, DDRNSDMC_PUB_MMR_BASE + 2 * 0x1043);
writew(0xe7, DDRNSDMC_PUB_MMR_BASE + 2 * 0x2043);
...
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming CalUclkInfo::CalUClkTicksPer1uS to 0x2bc\n");
writew(0x2bc, DDRNSDMC_PUB_MMR_BASE + 2 * 0x20008);
...
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Programming VrefInGlobal::GlobalVrefInDAC to 0x1d\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Programming VrefInGlobal to 0xef\n");
writew(0xef, DDRNSDMC_PUB_MMR_BASE + 2 * 0x200b2);
...
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DfiFreqRatio_p0 to 0x1\n");
writew(0x1, DDRNSDMC_PUB_MMR_BASE + 2 * 0x200fa);
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming TristateModeCA::DisDynAdrTri_p0 to 0x1\n");
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming TristateModeCA::DDR2TMode_p0 to 0x0\n");
...
// INFO("[phyinit_C_initPhyConfig] Pstate=0, Memclk=1400MHz, Programming DMIPinPresent::RdDbiEnabled to 0x0\n");
...
writew(0xaf0, DDRNSDMC_PUB_MMR_BASE + 2 * 0x54003);
writew(0x2, DDRNSDMC_PUB_MMR_BASE + 2 * 0x54004);
writew(0x0, DDRNSDMC_PUB_MMR_BASE + 2 * 0x54005);
writew(0x12, DDRNSDMC_PUB_MMR_BASE + 2 * 0x54006);
...
writew(0x1444, DDRNSDMC_PUB_MMR_BASE + 2 * 0x5401b);
writew(0x2008, DDRNSDMC_PUB_MMR_BASE + 2 * 0x5401c);
...
writew(0x1444, DDRNSDMC_PUB_MMR_BASE + 2 * 0x54021);
writew(0x2008, DDRNSDMC_PUB_MMR_BASE + 2 * 0x54022);
...
writew(0x814, DDRNSDMC_PUB_MMR_BASE + 2 * 0x54035);
writew(0x20, DDRNSDMC_PUB_MMR_BASE + 2 * 0x54036);
...
writew(0x814, DDRNSDMC_PUB_MMR_BASE + 2 * 0x5403b);
writew(0x20, DDRNSDMC_PUB_MMR_BASE + 2 * 0x5403c);
...
// // [phyinit_I_loadPIEImage] Pstate=0,  Memclk=1400MHz, Programming Seq0BDLY0 to 0x58
writew(0x58, DDRNSDMC_PUB_MMR_BASE + 2 * 0x2000b);
// // [phyinit_I_loadPIEImage] Pstate=0,  Memclk=1400MHz, Programming Seq0BDLY1 to 0xaf
writew(0xaf, DDRNSDMC_PUB_MMR_BASE + 2 * 0x2000c);
// // [phyinit_I_loadPIEImage] Pstate=0,  Memclk=1400MHz, Programming Seq0BDLY2 to 0x6d6
writew(0x6d6, DDRNSDMC_PUB_MMR_BASE + 2 * 0x2000d);
// // [phyinit_I_loadPIEImage] Pstate=0,  Memclk=1400MHz, Programming Seq0BDLY3 to 0x2c
...
// // [phyinit_I_loadPIEImage] Pstate=0, Memclk=1400MHz, Programming PPTTrainSetup::PhyMstrTrainInterval to 0xa
// // [phyinit_I_loadPIEImage] Pstate=0, Memclk=1400MHz, Programming PPTTrainSetup::PhyMstrMaxReqToAck to 0x5
// // [phyinit_I_loadPIEImage] Pstate=0, Memclk=1400MHz, Programming PPTTrainSetup2::PhyMstrFreqOverride to 0x3
