...
struct test tests[] = {
    ...
    { "32-bit Writes", test_32bit_wide_random },
#endif
    { NULL, NULL }
};
...
void memtester(void) {
    ...
    ul i = 0;
    #if STUCK == 1
    size_t bufsize, count = 0x1000;
    void volatile *aligned;
    #else
    size_t count = 0x1000;
    #endif
    ulv *bufa = (ulv *)0x18, *bufb = (ulv *)0x10000010;
    ul testmask = 0;
    int	errcnt = 0;

    //bufa = (ulv *)((ul)(rand_ul() & ~0x80000003));
    //bufb = (ulv *)((ul)((rand_ul() + 0x80000) & ~0x80000003));
