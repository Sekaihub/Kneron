...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/vtcs_toolchain/leipzig/bin',
 'BINLIBDEST': '/opt/vtcs_toolchain/leipzig/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': '/usr/bin/gcc -pthread -shared '
              '-L/opt/vtcs_toolchain/leipzig//lib '
              '-Wl,-rpath,/opt/vtcs_toolchain/leipzig//lib '
              '-Wl,--enable-new-dtags',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -O2 '
           '-I/opt/vtcs_toolchain/leipzig//include',
 'CFLAGSFORSHARED': '-fPIC',
 'CFLAGS_ALIASING': '',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-O2 -I/opt/vtcs_toolchain/leipzig//include',
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            '-Wno-missing-field-initializers '
                            '-Wstrict-prototypes '
                            '-Werror=implicit-function-declaration '
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/opt/vtcs_toolchain/leipzig//include',
 'CONFIGURE_LDFLAGS': '-L/opt/vtcs_toolchain/leipzig//lib '
                      '-Wl,-rpath,/opt/vtcs_toolchain/leipzig//lib '
                      '-Wl,--enable-new-dtags',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/opt/vtcs_toolchain/leipzig/' "
                "'--sysconfdir=/opt/vtcs_toolchain/leipzig//etc' "
                "'--localstatedir=/opt/vtcs_toolchain/leipzig//var' "
                ...
                "'PKG_CONFIG=/opt/vtcs_toolchain/leipzig//bin/pkg-config' "
                "'PKG_CONFIG_LIBDIR=/opt/vtcs_toolchain/leipzig//lib/pkgconfig:/opt/vtcs_toolchain/leipzig//share/pkgconfig' "
                "'CC=/usr/bin/gcc' 'CFLAGS=-O2 "
                "-I/opt/vtcs_toolchain/leipzig//include' "
                "'LDFLAGS=-L/opt/vtcs_toolchain/leipzig//lib "
                '-Wl,-rpath,/opt/vtcs_toolchain/leipzig//lib '
                "-Wl,--enable-new-dtags' "
                "'CPPFLAGS=-I/opt/vtcs_toolchain/leipzig//include' "
                "'CPP=/usr/bin/cpp'",
 'CONFINCLUDEDIR': '/opt/vtcs_toolchain/leipzig/include',
 'CONFINCLUDEPY': '/opt/vtcs_toolchain/leipzig/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/ernie.lu/workspace/pack/src/kl730/bsp/buildroot/output/build/host-python3-3.11.6/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/ernie.lu/workspace/pack/src/kl730/bsp/buildroot/output/build/host-python3-3.11.6/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.11 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/opt/vtcs_toolchain/leipzig//include',
 ...
 'DESTDIRS': '/opt/vtcs_toolchain/leipzig /opt/vtcs_toolchain/leipzig/lib '
             '/opt/vtcs_toolchain/leipzig/lib/python3.11 '
             '/opt/vtcs_toolchain/leipzig/lib/python3.11/lib-dynload',
 'DESTLIB': '/opt/vtcs_toolchain/leipzig/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/opt/vtcs_toolchain/leipzig/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/vtcs_toolchain/leipzig/include '
                   '/opt/vtcs_toolchain/leipzig/include '
                   '/opt/vtcs_toolchain/leipzig/include/python3.11 '
                   '/opt/vtcs_toolchain/leipzig/include/python3.11',
 'INCLUDEDIR': '/opt/vtcs_toolchain/leipzig/include',
 'INCLUDEPY': '/opt/vtcs_toolchain/leipzig/include/python3.11',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': '/usr/bin/gcc -pthread -shared -L/opt/vtcs_toolchain/leipzig//lib '
             '-Wl,-rpath,/opt/vtcs_toolchain/leipzig//lib '
             '-Wl,--enable-new-dtags',
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/opt/vtcs_toolchain/leipzig/lib/python3.11',
 'LIBDIR': '/opt/vtcs_toolchain/leipzig/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -O2 '
                    '-I/opt/vtcs_toolchain/leipzig//include -std=c11 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
                    '-Wstrict-prototypes -Werror=implicit-function-declaration '
                    '-fvisibility=hidden  -I./Include/internal -I. -I./Include '
                    '-I/opt/vtcs_toolchain/leipzig//include -fPIC -fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/opt/vtcs_toolchain/leipzig/include',
 'LIBM': '-lm',
 ...
 'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 '
                    ...
                    '-Wall -O2 -I/opt/vtcs_toolchain/leipzig//include -std=c11 '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/vtcs_toolchain/leipzig/lib/pkgconfig',
 'LIBPL': '/opt/vtcs_toolchain/leipzig/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/vtcs_toolchain/leipzig/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': '/usr/bin/gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/vtcs_toolchain/leipzig/share/man',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/opt/vtcs_toolchain/leipzig/include',
 'MODULE_BINASCII_LDFLAGS': '-L/opt/vtcs_toolchain/leipzig/lib -lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/opt/vtcs_toolchain/leipzig/include',
 'MODULE_ZLIB_LDFLAGS': '-L/opt/vtcs_toolchain/leipzig/lib -lz',
 ...
 'MODULE__LZMA_CFLAGS': '-I/opt/vtcs_toolchain/leipzig/include',
 'MODULE__LZMA_LDFLAGS': '-L/opt/vtcs_toolchain/leipzig/lib -llzma',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -O2 '
                             '-I/opt/vtcs_toolchain/leipzig//include -std=c11 '
                             '-Wextra -Wno-unused-parameter '
                             '-Wno-missing-field-initializers '
                             '-Wstrict-prototypes '
                             '-Werror=implicit-function-declaration '
                             ...
                             '-I./Include '
                             '-I/opt/vtcs_toolchain/leipzig//include -fPIC '
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -O2 '
                   ...
                   '-I/opt/vtcs_toolchain/leipzig//include -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/opt/vtcs_toolchain/leipzig//lib '
                    '-Wl,-rpath,/opt/vtcs_toolchain/leipzig//lib '
                    '-Wl,--enable-new-dtags',
 'PY_CPPFLAGS': '-I. -I./Include -I/opt/vtcs_toolchain/leipzig//include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/opt/vtcs_toolchain/leipzig//lib '
               '-Wl,-rpath,/opt/vtcs_toolchain/leipzig//lib '
               '-Wl,--enable-new-dtags',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/opt/vtcs_toolchain/leipzig//lib '
                     '-Wl,-rpath,/opt/vtcs_toolchain/leipzig//lib '
                     '-Wl,--enable-new-dtags',
 ...
 'PY_STDMODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -O2 '
                        ...
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I./Include/internal -I. '
                        '-I./Include -I/opt/vtcs_toolchain/leipzig//include '
                        '-fPIC',
 'PY_SUPPORT_TIER': 1,
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 1,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/ernie.lu/workspace/pack/src/kl730/bsp/buildroot/output/build/host-python3-3.11.6',
 'SCRIPTDIR': '/opt/vtcs_toolchain/leipzig/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/ernie.lu/workspace/pack/src/kl730/bsp/buildroot/output/build/host-python3-3.11.6 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/home/ernie.lu/workspace/pack/src/kl730/bsp/buildroot/output/build/host-python3-3.11.6 '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './opt/vtcs_toolchain/leipzig',
 'WASM_STDLIB': './opt/vtcs_toolchain/leipzig/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/home/ernie.lu/workspace/pack/src/kl730/bsp/buildroot/output/build/host-python3-3.11.6',
 'abs_srcdir': '/home/ernie.lu/workspace/pack/src/kl730/bsp/buildroot/output/build/host-python3-3.11.6',
 'datarootdir': '/opt/vtcs_toolchain/leipzig/share',
 'exec_prefix': '/opt/vtcs_toolchain/leipzig',
 'prefix': '/opt/vtcs_toolchain/leipzig',
 'srcdir': '.'}
